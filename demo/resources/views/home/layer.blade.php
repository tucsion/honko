    ...
    <div id="head">
        ...
        <div id="nav">
            <ul class="layui-nav container" lay-filter="">
                ...
                @endif
                >
                    <a href="{{ url('http://hkyl.com/expert/index') }}">专家团队</a>
                    <dl class="layui-nav-child">
                    @foreach($expert as $experts)
                        <dd><a href="{{ url('http://hkyl.com/expert/zjlist') }}/zc={{$experts -> id}}">{{ $experts -> cate }}</a></dd>
                    @endforeach 
                    </dl>
                </li>
                <li 
                ...
                @elseif($xuanzhe != 3)
                  class= "layui-nav-item" 
                @endif>
                    <a href="{{ url('http://hkyl.com/train/index') }}/{{$jiaoyu -> id}}">教育与培训</a>
                    <dl class="layui-nav-child">
                    @foreach($train as $train)
                        <dd><a href="{{ url('http://hkyl.com/train/index') }}/{{$train -> id}}">{{ $train -> cate }}</a></dd>
                    @endforeach 
                    </dl>
                </li>
                <li 
                ...
                @elseif($xuanzhe != 4)
                  class= "layui-nav-item" 
                @endif>
                    <a href="{{ url('http://hkyl.com/health/index') }}/{{$yangsheng -> id}}">养生养老</a>
                    <dl class="layui-nav-child">
                    @foreach($ys as $res)
                        <dd><a href="{{ url('http://hkyl.com/health/index') }}/{{$res -> id}}">{{ $res -> cate }}</a></dd>
                    @endforeach 
                    </dl>
                </li>
                <li 
                ...
                @elseif($xuanzhe != 5)
                  class= "layui-nav-item" 
                @endif>
                    <a href="{{ url('http://hkyl.com/hickey/index') }}">康复器械园</a>
                    <dl class="layui-nav-child">
                    @foreach($hickey as $h)
                ...
                @elseif($xuanzhe != 6)
                  class= "layui-nav-item" 
                @endif>
                    <a href="{{ url('http://hkyl.com/procure/index') }}/{{$qiye -> id}}">企业采购</a>
                    <dl class="layui-nav-child">
                    @foreach($procure as $procure)
                        <dd><a href="{{ url('http://hkyl.com/procure/index') }}/{{$procure -> id}}">{{ $procure -> cate }}</a></dd>
                    @endforeach 
                    </dl>
                </li>
                <li  
                ...
                @elseif($xuanzhe != 7)
                  class= "layui-nav-item" 
                @endif>
                    <a href="{{ url('http://hkyl.com/store/index') }}">网上商城</a>
                    <dl class="layui-nav-child">
                ...
                @elseif($xuanzhe != 8)
                    class= "layui-nav-item" 
                @endif>
                    <a href="{{ url('http://hkyl.com/info/index') }}/{{$huiyi -> id}}">康复资讯</a>
                    <dl class="layui-nav-child">
                    @foreach($health as $health)
                        <dd><a href="{{ url('http://hkyl.com/info/index') }}/{{$health -> id}}">{{ $health -> cate }}</a></dd>
                    @endforeach 
                    </dl>
                </li>
            </ul>
    ...
    <div id="member" class="container">
        ...
        @if(session('user')->utp == 1)
            <dl>
                ...
                <dd><a href="/home/user/base"><i class="layui-icon">&#xe623;</i> 基础资料</a></dd>
                <dd><a href="/home/user/address"><i class="layui-icon">&#xe623;</i> 地址管理</a></dd>
                <dd><a href="/home/user/bill" ><i class="layui-icon">&#xe623;</i> 发票管理</a></dd>
                <dd><a href="/home/user/rz"><i class="layui-icon">&#xe623;</i> 认证管理</a></dd>
                <dd><a href="/home/user/pass"><i class="layui-icon">&#xe623;</i> 修改密码</a></dd>
            </dl>
            <dl>
                <dt class="headTitle">病历管理</dt>
                <dd><a href="/ill/man"><i class="layui-icon">&#xe623;</i> 人物管理</a></dd>
                <dd><a href="/ill/cases"><i class="layui-icon">&#xe623;</i> 病历管理</a></dd>
            </dl>
            <dl>
                <dt class="headTitle">订单管理</dt>
                <dd><a href="/order/serve"><i class="layui-icon">&#xe623;</i> 服务订单</a></dd>
                <dd><a  href="/order/goods" ><i class="layui-icon">&#xe623;</i> 商城订单</a></dd>
            </dl>
            <dl>
                <dt class="headTitle">我的收藏</dt>
                <dd><a href="/fav/zj"><i class="layui-icon">&#xe623;</i> 收藏的专家</a></dd>
                <dd><a href="/fav/goods"><i class="layui-icon">&#xe623;</i> 收藏的器械</a></dd>
                <dd><a href="/fav/wz"><i class="layui-icon">&#xe623;</i> 收藏的资料</a></dd>
            </dl>
            <dl>
                <dt class="headTitle">积分等级</dt>
                <dd><a href="/mymark/index"><i class="layui-icon">&#xe623;</i> 我的积分</a></dd>
                <dd><a href="/mymark/addrule"><i class="layui-icon">&#xe623;</i> 积分规则</a></dd>
            </dl>
            <dl>
                <dt class="headTitle">消息中心</dt>
                <dd><a href="/message/xitong" ><i class="layui-icon">&#xe623;</i>&nbsp;系统消息&nbsp;<small id='winmsd' style="color:red; display:none;float: right;margin-right: 10px;">新</small></a></dd>
                <dd><a href="/message/deal"><i class="layui-icon">&#xe623;</i>&nbsp;交易提醒&nbsp;<small id='deal' style="color:red; display:none;float: right;margin-right: 10px;">新</small></a></dd>
                <dd><a href="/message/zixun"><i class="layui-icon">&#xe623;</i> 专家回复</a></dd>
                <dd><a  href="/message/myword"><i class="layui-icon">&#xe623;</i>&nbsp;我的留言&nbsp;<small id='myword' style="color:red; display:none;float: right;margin-right: 10px;">新</small></a></dd>
            </dl>
        @endif
        @if(session('user') -> utp == 2)
            <dl>
                <dt class="headTitle">资料管理</dt>
                <dd><a href="/home/zjuser/base"><i class="layui-icon">&#xe623;</i> 基础资料</a></dd>
                <dd><a href="/home/user/rz"><i class="layui-icon">&#xe623;</i> 认证管理</a></dd>
                <dd><a href="/home/user/pass"><i class="layui-icon">&#xe623;</i> 修改密码</a></dd>
            ...
            <dl>
                ...
                <dd><a href="/home/zjuser/base"><i class="layui-icon">&#xe623;</i> 关注的病人</a></dd>
                <dd><a href="/home/tuisong/xitong"><i class="layui-icon">&#xe623;</i>&nbsp;系统推送&nbsp;<small id='tuisong' style="color:red; display:none;float: right;margin-right: 10px;">新</small></a></dd>
            </dl>
             <dl>
                <dt class="headTitle">学术资料</dt>
                <dd><a href="/home/zjuser/base"><i class="layui-icon">&#xe623;</i> 资料列表</a></dd>
                <dd><a href="/home/zjuser/base"><i class="layui-icon">&#xe623;</i> 发布资料</a></dd>
            </dl>
            <dl>
                <dt class="headTitle">积分等级</dt>
                <dd><a href="/mymark/index"><i class="layui-icon">&#xe623;</i> 我的积分</a></dd>
                <dd><a href="/mymark/addrule"><i class="layui-icon">&#xe623;</i> 积分规则</a></dd>
                <dd><a href="/mymark/level"><i class="layui-icon">&#xe623;</i> 等级规则</a></dd>
            </dl>
             <dl>
                <dt class="headTitle">订单管理</dt>
                <dd><a href="/home/zjuser/base"><i class="layui-icon">&#xe623;</i> 服务订单</a></dd>
            </dl>
             <dl>
                <dt class="headTitle">财务管理</dt>
                <dd><a href="/home/zjuser/base"><i class="layui-icon">&#xe623;</i> 提现订单</a></dd>
                <dd><a href="/home/zjuser/base"><i class="layui-icon">&#xe623;</i> 收入管理</a></dd>
            </dl>
            <dl>
                <dt class="headTitle">消息中心</dt>
                <dd><a href="/message/xitong" ><i class="layui-icon">&#xe623;</i>&nbsp;系统消息&nbsp;<small id='winmsd' style="color:red; display:none;float: right;margin-right: 10px;">新</small></a></dd>
                <dd><a href="/message/deal"><i class="layui-icon">&#xe623;</i>&nbsp;患者交流&nbsp;<small id='deal' style="color:red; display:none;float: right;margin-right: 10px;">新</small></a></dd>
            </dl>
        @endif
            
            <dl>
                <dt class="headTitle">其他</dt>
                <dd><a href="/home/logout"><i class="layui-icon">&#xe623;</i> 退出登录</a></dd>
            </dl>
        </div>
